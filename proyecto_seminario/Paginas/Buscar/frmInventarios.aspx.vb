...
#End Region
    ...
    Public Sub fLlenarGrid()
        Try
            ...
            stInventario.DataSource = v.fListarInventarios(_lugar, _idModelo, _Familia, _Material, _Producto)
            stInventario.DataBind()
            Dim dt As New DataTable
            dt = stInventario.DataSource
            _Producto = ""
    ...
    Private Sub fobtenerValoresQuerystring()
        If Request.QueryString.AllKeys.Contains("lugar") Then
            _lugar = CStr(Request.QueryString("lugar").ToString)
        End If
