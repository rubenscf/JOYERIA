<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmEditarSolicitudCompra.aspx.vb" Inherits="proyecto_seminario.frmEditarSolicitudCompra" %>
...
<body>
    <form id="form1" runat="server">
        <ext:ResourceManager ID="rmESolicitudCompra" runat="server" />
            ...
            <Items>
                <ext:FormPanel ID="FormPanel2" runat="server" Frame="false" BodyPadding="8">
                    <FieldDefaults LabelAlign="Right" LabelWidth="120" MsgTarget="Qtip" />
                     <Items>
                        <ext:TextField runat="server" ID="txtidsolicitud" Flex="1" Visible="false" />
                        <ext:TextField runat="server" ID="txtproveedor" FieldLabel="proveedor :" Flex="1" AllowBlank="false" Width="330" />
                    ...
                    <Buttons>
                        ...
                        <ext:Button ID="btnCancelar" runat="server" Text="Cancelar" Icon="Cancel" Width="110">
                            <Listeners>
                                <Click Handler="fCerrarVentanaSolicitudCompra();" />
                            </Listeners>
                        </ext:Button>
                    </Buttons>
                </ext:FormPanel>
