...
<body>
    <form runat="server">
        ...
        <ext:Panel runat="server" Flex="1" Height="475" Layout="BorderLayout">
            <Items>
                <ext:Container runat="server">
                    <Items>
                        <ext:GridPanel ID="GridPanel11" runat="server" Region="West" Width="875" Title="Información de los Períodos Activos"   MarginSpec="5 5 5 5">


                             <ColumnModel>
                        <Columns>

                             <ext:Column runat="server" ID="Column2" Text="Año" Width="100" Align="Center" DataIndex="ANIO"/>
                            ...
                            <ext:DateColumn runat="server" Format="dd/MM/yyyy" Text="Fecha Fin"  Align="Center" DataIndex="FIN">
                             ...
                             <ext:Column runat="server" ID="Column3" Text="ID MES" Visible="false" Width="100" Align="Center" DataIndex="IDMES"/>
                            <ext:Column runat="server" ID="Column4" Text="Mes" flex="1" Align="Center" DataIndex="MES"/>
                            <ext:DateColumn runat="server" Format="dd/MM/yyyy" Text="Desde"  Align="Center" DataIndex="DESDE">
                                <Editor>
                                    <ext:DateField runat="server"/>
                                </Editor>
                            </ext:DateColumn>
                            <ext:DateColumn ID="DateColumn1" runat="server" Format="dd/MM/yyyy"   Text="Hasta"  Align="Center" DataIndex="HASTA">
                                <CustomConfig>
                                ...
                                <ext:CommandColumn ID="CommandColumn2" runat="server" Width="75" Text="Tareas" Align="Center">
                                <Commands>
                                ...
                                <Listeners>
                                      <Command Handler="fModificar(command,record);" />
                                </Listeners>
                                </ext:CommandColumn>
                            ...
                            <BottomBar>
                        <ext:PagingToolbar ID="PagingToolbar3" runat="server" DisplayInfo="true" DisplayMsg="Mostrando {0} - {1} of {2}"
                            EmptyMsg="No hay datos que mostrar" />
                    </BottomBar>
                        </ext:GridPanel>


                        <ext:GridPanel ID="GridPanel2" runat="server" Region="West" Width="875" Title="Información de los Períodos Activos"   MarginSpec="5 5 5 5">
                            <BottomBar>
                        <ext:PagingToolbar ID="PagingToolbar2" runat="server" DisplayInfo="true" DisplayMsg="Mostrando {0} - {1} of {2}"
                            EmptyMsg="No hay datos que mostrar" />
                    </BottomBar>
